...
public class HeadPublishWantBuyBean {
    ...
    public HeadPublishWantBuyBean(String wantBuyNum, String province, String city, String plantType,String spec, String timeLimit, String name, String phone, String fromProvince, String fromCity) {
