...
public class SeedlingDetailJavaBean {
    ...
    public double getIsCollection() {
        return isCollection;
    }

    public void setIsCollection(double isCollection) {
    ...
    public double getSeedlingId() {
        return seedlingId;
    }

    public void setSeedlingId(double seedlingId) {
