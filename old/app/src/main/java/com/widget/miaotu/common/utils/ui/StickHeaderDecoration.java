...
public class StickHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickHeaderDecoration(Context context) {
        ...
        mItemHeaderHeight = dp2px(context, 25);
        mTextPaddingLeft = dp2px(context, 13);

        mTextRect = new Rect();

        mItemHeaderPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mItemHeaderPaint.setColor(Color.parseColor("#F7F7F7"));
        ...
        mLinePaint.setColor(Color.parseColor("#F2F2F2"));
        ...
        if (parent.getAdapter() instanceof RecyclerViewAdapter) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (isHeader) {
                    ...
                    c.drawRect(dp2px(context,13), view.getTop() - 1, right, view.getTop(), mLinePaint);
                }
            }
        }
    }
