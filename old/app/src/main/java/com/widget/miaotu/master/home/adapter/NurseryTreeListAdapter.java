...
public class NurseryTreeListAdapter extends CommonAdapter<SeedListGetBean> {


    public NurseryTreeListAdapter(Context context, int layoutId, List<SeedListGetBean> datas) {
        super(context, layoutId, datas);
    }


    @Override
    protected void convert(ViewHolder holder, SeedListGetBean item, int position) {
...
//                }
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            String[] value = {"1", item.getGardenId() + "", item.getId() + "", item.getUserId() + ""};
