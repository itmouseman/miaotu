package com.widget.miaotu.common.utils.home.search;
...
public class SearchView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.home_gray2); // 默认颜色 = 灰色
        ...
        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.white_color); // 默认颜色 = 白色
