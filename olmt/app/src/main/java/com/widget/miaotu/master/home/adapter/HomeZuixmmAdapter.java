...
//        );
        holder.tvHomeZxmm6.setText(mSListByTypeJavaBeanLists.get(position).getPrice() == 0 ? "面议" : "￥"+mSListByTypeJavaBeanLists.get(position).getPrice() + "/株起"
        );
        ...
        holder.tvHomeZxmm4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent4 = new Intent();
                intent4.putExtra("userId", String.valueOf(mSListByTypeJavaBeanLists.get(position).getUserId()));
                intent4.putExtra("company_id", String.valueOf(mSListByTypeJavaBeanLists.get(position).getCompanyId()));
                intent4.setClass(mContext, CompanyDetailActivity.class);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] value = {"1", mSListByTypeJavaBeanLists.get(position).getId() + ""};
