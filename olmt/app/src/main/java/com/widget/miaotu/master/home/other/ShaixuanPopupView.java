...
public class ShaixuanPopupView extends DrawerPopupView {
    ...
    private int diameterFloor;//	起始杆径
    private int diameterUpper;//截止杆径
    private int heightFloor;//起始高度
    private int heightUpper;//截止高度
    private int crownFloor;//起始冠幅
    private int crownUpper;//截止冠幅
    private String type;
        ...
        findViewById(R.id.tv_ShaiXuan_Sure).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(et_gj_start.getText().toString().trim())) {
                    diameterFloor = Integer.parseInt(et_gj_start.getText().toString().trim());
                }
                if (!TextUtils.isEmpty(et_gj_end.getText().toString().trim())) {
                    diameterUpper = Integer.parseInt(et_gj_end.getText().toString().trim());
                }
                ...
                if (!TextUtils.isEmpty(et_gd_start.getText().toString().trim())) {
                    heightFloor = Integer.parseInt(et_gd_start.getText().toString().trim());
                }
                if (!TextUtils.isEmpty(et_gd_end.getText().toString().trim())) {
                    heightUpper = Integer.parseInt(et_gd_end.getText().toString().trim());
                }
                ...
                if (!TextUtils.isEmpty(et_gf_start.getText().toString().trim())) {
                    crownFloor = Integer.parseInt(et_gf_start.getText().toString().trim());
                }
                if (!TextUtils.isEmpty(et_gf_end.getText().toString().trim())) {
                    crownUpper = Integer.parseInt(et_gf_end.getText().toString().trim());
                }

                //杆径 --滚轮
                if (!TextUtils.isEmpty(seekBarGjStart)) {
                    diameterFloor = Integer.parseInt(seekBarGjStart);
                }
                if (!TextUtils.isEmpty(seekBarGjEnd)) {

                    diameterUpper = Integer.parseInt(seekBarGjEnd);
                }

                //高度  --滚轮
                if (!TextUtils.isEmpty(seekBarGdStart)) {

                    heightFloor = Integer.parseInt(seekBarGdStart);
                }
                if (!TextUtils.isEmpty(seekBarGdEnd)) {

                    heightUpper = Integer.parseInt(seekBarGdEnd);
                }

                //冠幅  --滚轮
                if (!TextUtils.isEmpty(seekBarGfStart)) {

                    crownFloor = Integer.parseInt(seekBarGfStart);
                }
                if (!TextUtils.isEmpty(seekBarGfEnd)) {
                    crownUpper = Integer.parseInt(seekBarGfEnd);
                }
                ...
                if (mSelectTextLeixing.equals("不限")) {
                    mSelectTextLeixing = "";
                }
...
//        mDataChangeCallBack.selectChangeData(searchWord, String.valueOf(diameterFloor), String.valueOf(diameterUpper), String.valueOf(heightFloor), String.valueOf(heightUpper), String.valueOf(crownFloor), String.valueOf(crownUpper), province, city, type, mSelectTextLeixing, companyStatus);
    ...
    public interface DataChangeCallBack {
        ...
        void selectChangeData(String searchWord, String diameterFloor, String diameterUpper, String heightFloor, String heightUpper, String crownFloor,
                              String crownUpper, String province, String city, String type, String plantType, int companyStatus);
    }
}