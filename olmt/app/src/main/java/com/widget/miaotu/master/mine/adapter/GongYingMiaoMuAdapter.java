...
public class GongYingMiaoMuAdapter extends BaseQuickAdapter<SeedListGetBean, BaseViewHolder> {

    private final Context mContext;

    public GongYingMiaoMuAdapter(Context context, int layoutResId, @Nullable List<SeedListGetBean> data) {
...
//            helper.setVisible(R.id.ll_garden_name,false);
        ...
        if (0 == item.getStatus()) {
            ...
            holder.setVisible(R.id.tv_demand_list_nick_price,false);
        } else {
            holder.setVisible(R.id.tv_demand_review, false);
            holder.setVisible(R.id.imageView68, false);
        }
