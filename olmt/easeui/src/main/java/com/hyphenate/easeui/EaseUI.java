...
//        options.setUseFCM(demoModel.isUseFCM());
         ...
         */
        EMPushConfig.Builder builder = new EMPushConfig.Builder(getContext());
        Log.e("PushClient2","进入推送");
        builder
                .enableVivoPush() // 需要在AndroidManifest.xml中配置appId和appKey//更新
                .enableMeiZuPush("118654", "eaf530ff717f479cab93714d45972ff6")
                .enableMiPush("2882303761517434463", "5751743434463")//更新
