...
//            //set nickname and avatar
//
//            String myHeadPhoto = message.getStringAttribute("myHeadPhoto", "");
//            String youHeadPhoto = message.getStringAttribute("youHeadPhoto", "");
//            if (message.direct() == Direct.SEND) {
//                Log.e("HYLoggg2",youHeadPhoto+"----------"+myHeadPhoto);
//                if (!TextUtils.isEmpty(myHeadPhoto)) {
//                    Glide.with(context).load(myHeadPhoto).into(userAvatarView);
//                } else {
//                    EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
//
//                }
...
//            } else {
//
//                if (!TextUtils.isEmpty(youHeadPhoto)) {
//                    Glide.with(context).load(youHeadPhoto).into(userAvatarView);
//                }else {
//                    EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
//                    EaseUserUtils.setUserNick(message.getFrom(), usernickView);
//                }
